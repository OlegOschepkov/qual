...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_init_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/init-select */ "./js/modules/init-select.js");
/* harmony import */ var _modules_init_noui_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-noui-slider */ "./js/modules/init-noui-slider.js");
/* harmony import */ var _modules_init_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-perfect-scrollbar */ "./js/modules/init-perfect-scrollbar.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_init_select__WEBPACK_IMPORTED_MODULE_0__["initSelects"])();
  Object(_modules_init_noui_slider__WEBPACK_IMPORTED_MODULE_1__["initNoUiSlider"])();
  Object(_modules_init_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_2__["initPerfectScrollbar"])();
...
var initMenu = function initMenu() {
  var menuBtn = document.querySelector('[data-show-menu]');
  ...
  menuBtn.addEventListener('click', function (e) {
    ...
    if (menu.classList.contains('is-active')) {
      menu.style.maxHeight = "calc(100vh - ".concat(headerHeight, "px)");
      var _ps = new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"](menu, {
        wheelSpeed: 2,
...
/***/ "./js/modules/init-noui-slider.js":
/*!****************************************!*\
  !*** ./js/modules/init-noui-slider.js ***!
  \****************************************/
...
var initNoUiSlider = function initNoUiSlider() {
  ...
  sliders.forEach(function (rangeSlider) {
    var name = rangeSlider.dataset.rangeSlider;
    var valueField = rangeSlider.querySelector('[data-range-slider-value]');
    var valueFieldSuffix = valueField.dataset.suffix;
    var valueFieldValue = valueField.querySelector('span');
...
/***/ "./js/modules/init-perfect-scrollbar.js":
/*!**********************************************!*\
  !*** ./js/modules/init-perfect-scrollbar.js ***!
  \**********************************************/
/*! exports provided: initPerfectScrollbar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPerfectScrollbar", function() { return initPerfectScrollbar; });
/* harmony import */ var perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! perfect-scrollbar */ "../node_modules/perfect-scrollbar/dist/perfect-scrollbar.esm.js");

var initPerfectScrollbar = function initPerfectScrollbar() {
  var slimSelectLists = document.querySelectorAll('.ss-list');
  if (slimSelectLists.length) {
    slimSelectLists.forEach(function (list) {
      var ps = new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"](list, {
        wheelSpeed: 1,
        wheelPropagation: false,
        minScrollbarLength: 53
      });
...
/* harmony import */ var _vendor_slimselect_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/slimselect.min */ "./js/vendor/slimselect.min.js");
/* harmony import */ var _vendor_slimselect_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_slimselect_min__WEBPACK_IMPORTED_MODULE_0__);

var initSelects = function initSelects() {
  var selects = document.querySelectorAll('[data-select]');
  if (!selects.length) return;
  selects.forEach(function (select) {
    var placeholder = select.dataset.placeholderText;
    new _vendor_slimselect_min__WEBPACK_IMPORTED_MODULE_0___default.a({
      select: select,
      settings: {
        showSearch: false,
  ...
  var o = /*#__PURE__*/function () {
    ...
    _createClass(o, [{
      ...
      value: function mainDiv() {
        ...
        var n = null === (e = this.store) || void 0 === e ? void 0 : e.getSelectedOptions();
        !this.settings.allowDeselect || this.settings.isMultiple && n && n.length <= 0 ? i.classList.add(this.classes.hide) : i.classList.remove(this.classes.hide), i.onclick = function (e) {
        ...
        return c.setAttribute("d", this.classes.arrowClose), this.settings.alwaysOpen && _o.classList.add(this.classes.hide), _o.appendChild(c), t.appendChild(_o), {
          main: t,
          values: s,
          deselect: {
            main: i,
      ...
      value: function renderSingleValue() {
        ...
        if (t) {
          ...
          _e5.classList.add(this.classes.single), t.html ? _e5.innerHTML = t.html : _e5.innerText = t.text, this.main.values.innerHTML = _e5.outerHTML;
        ...
        if (s.classList.add(this.classes.valueText), s.innerText = e.text, t.appendChild(s), !e.mandatory) {
          ...
          _s5.classList.add(this.classes.valueDelete), _s5.onclick = function (t) {
            ...
            if (!(_this3.settings.minSelected && l.length < _this3.settings.minSelected) && (_this3.callbacks.beforeChange && (s = !0 === _this3.callbacks.beforeChange(l, i)), s)) {
              ...
              _this3.callbacks.setSelected(_e9, !1), _this3.settings.closeOnSelect && _this3.callbacks.close(), _this3.callbacks.afterChange && _this3.callbacks.afterChange(l), _this3.updateDeselectAll();
            }
          };
          ...
          var _loop3 = function _loop3() {
            ...
            if (t instanceof n) {
              ...
              if (_n4.classList.add(_this5.classes.optgroupActions), _s9.appendChild(_n4), _this5.settings.isMultiple && t.selectAll) {
                ...
                _o2.setAttribute("d", _this5.classes.optgroupSelectAllCheck), _a2.appendChild(_o2), _e16.addEventListener("click", function (e) {
      ...
      value: function option(e) {
        ...
        return t.dataset.id = e.id, t.id = e.id, t.classList.add(this.classes.option), t.setAttribute("role", "option"), e.class && e.class.split(" ").forEach(function (e) {
          ...
          var _o3 = [];
          _this6.settings.isMultiple && (_o3 = e.selected ? l.filter(function (e) {
            return e.id !== n;
          }) : l.concat(e)), _this6.settings.isMultiple || (_o3 = e.selected ? [] : [e]), _this6.callbacks.beforeChange || (a = !0), _this6.callbacks.beforeChange && (a = !1 !== _this6.callbacks.beforeChange(_o3, l)), a && (_this6.store.getOptionByID(n) || _this6.callbacks.addOption(e), _this6.callbacks.setSelected(_o3.map(function (e) {
            return e.value;
